...
class InAppWebViewScrollDetectionPage extends StatefulWidget {
  const InAppWebViewScrollDetectionPage({super.key});

  @override
  State<InAppWebViewScrollDetectionPage> createState() =>
      _InAppWebViewScrollDetectionPageState();
}

class _InAppWebViewScrollDetectionPageState
    extends State<InAppWebViewScrollDetectionPage> {
  ...
  final String _scrollDetectionJS = '''
    (function() {
      var checkScroll = function() {
        ...
        // スクロール進捗を送信
        window.flutter_inappwebview.callHandler('scrollProgress', scrollProgress);
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text('InAppWebView Scroll Detection'),
            ...
            child: InAppWebView(
              ...
              onWebViewCreated: (controller) {
                ...
                controller.addJavaScriptHandler(
                  ...
                  callback: (args) {
                    setState(() {
                      _scrollProgress = args[0].toDouble();
                    });
                  },
                );
                ...
                controller.addJavaScriptHandler(
                  ...
                  callback: (args) {
                    if (!_isScrolledToEnd) {
                      ...
                      debugPrint(
                        "WebViewの最後までスクロールしました！ 時刻: $_scrolledToEndTime",
                      );
                    }
                  },
                );
              ...
              onLoadStop: (controller, url) async {
                ...
                await controller.evaluateJavascript(source: _scrollDetectionJS);
              },
